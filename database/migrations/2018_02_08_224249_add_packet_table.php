...
class AddPacketTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('packets',function (Blueprint $table) {
          ...
          $table->integer('status_table_id')->unsigned();
          $table->integer('status_sequence_id')->unsigned();
          $table->integer('health_table_id')->unsigned()->nullable();
          $table->integer('health_sequence_id')->unsigned()->nullable();
          $table->integer('imu_table_id')->unsigned()->nullable();
          $table->integer('imu_sequence_id')->unsigned()->nullable();
          $table->integer('img_table_id')->unsigned()->nullable();
          $table->integer('img_sequence_id')->unsigned()->nullable();
          $table->integer('gps_table_id')->unsigned()->nullable();
          $table->integer('gps_sequence_id')->unsigned()->nullable();
          $table->integer('config_table_id')->unsigned()->nullable();
